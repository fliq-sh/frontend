...
export const fieldClass =
  "w-full rounded-md border border-foreground/10 bg-foreground/5 px-3 py-2 text-sm text-foreground placeholder:text-foreground/48 focus:outline-none focus:ring-1 focus:ring-foreground/30 focus:border-foreground/20 transition-colors disabled:opacity-50";
...
export function Field({
  ...
  return (
    <div className={cn("flex flex-col gap-1.5", className)}>
      ...
      {children}
      {hint && <p className="text-xs text-foreground/58">{hint}</p>}
    </div>
  );
}
